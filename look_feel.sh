...
xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;c -n -t "string" -s "close_window_key"

xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;bracketleft -n -t "string" -s "tile_left_key"
xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;bracketright -n -t "string" -s "tile_right_key"
xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;minus -n -t "string" -s "tile_up_key"
xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;equal -n -t "string" -s "tile_down_key"

xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Alt&gt;f -n -t "string" -s "fullscreen_key"
xfconf-query -c xfce4-keyboard-shortcuts -p /xfwm4/custom/&lt;Shift&gt;&lt;Alt&gt;m -n -t "string" -s "maximize_window_key"
